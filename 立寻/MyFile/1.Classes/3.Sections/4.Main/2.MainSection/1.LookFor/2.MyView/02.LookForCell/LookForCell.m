...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary{
    if (self = [super init]) {
        ...
        //头像
        {
            NSString * user_url = dictionary[@"user_url"];
        ...
        //用户名字
        {
            NSString * user_name = dictionary[@"user_name"];
...
//            CGSize size = [MYTOOL getSizeWithLabel:label];
        ...
        //全国推广
        {
            NSString * range = dictionary[@"range"];
        ...
        //丢失地
        {
            ...
            //地点
            {
                NSString * lost_place = dictionary[@"lost_place"];
...
//                [self addSubview:label];
        ...
        //图片
        {
            NSArray * url_array = dictionary[@"url"];
            ...
            for (int i = 0; i < 3 && i < url_array.count; i ++) {
                ...
                [MYTOOL setImageIncludePrograssOfImageView:icon withUrlString:url_array[i]];
                [self addSubview:icon];
            }
        }
        //下分割线
